...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <ul class="navbar-nav">
                ...
                <li><a href="ExplorarServlet" class="active">Explorar Recetas</a></li>
    ...
    <div class="container">
        ...
        <div class="categories">
            <a href="ExplorarReceta.jsp?categoria=Desayuno" class="category">
            ...
            <a href="ExplorarReceta.jsp?categoria=ALMUERZO" class="category">
                <div class="category-icon">🍝</div>
            ...
            <a href="ExplorarReceta.jsp?categoria=cena" class="category">
            ...
            <a href="ExplorarReceta.jsp?categoria=postre" class="category">
                <div class="category-icon">🍰</div>
            ...
            <a href="ExplorarReceta.jsp?categoria=snack" class="category">
                <div class="category-icon">🥨</div>
            ...
            <a href="ExplorarReceta.jsp?categoria=ensalada" class="category">
                <div class="category-icon">🥗</div>
            ...
            <a href="ExplorarReceta.jsp?categoria=guarnicion" class="category">
                <div class="category-icon">🥔</div>
